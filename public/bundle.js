!(function () {
  ...
  document.addEventListener("contextmenu", function (e) {
    ...
    document.addEventListener("keydown", function (e) {
      if ("F12" === e.key || 123 === e.keyCode) return e.preventDefault(), !1;
    });
  let o = [...i, ...a],
    t = o;
  const r = document.querySelector("#programas");
  let n = 12;
  const s = document.querySelector(".busqueda__item"),
    c = document.querySelector(".busqueda__btn");
  let d = 1;
  try {
    document.querySelector("#diseño").addEventListener("click", () => {
      (t = i), (d = 1), m(), g();
    });
  } catch (e) {}
  try {
    document.querySelector("#utilidades").addEventListener("click", () => {
      (t = a), (d = 1), m(), u(d), g();
    });
  } catch (e) {}
  try {
    c.addEventListener("click", () => {
      ...
      console.log(e),
        (t = o.filter((i) => i.nombre.toLowerCase().includes(e))),
        (d = 1),
        m(),
        g();
    });
  ...
  try {
    s.addEventListener("input", () => {
      "" === s.value.trim().toLowerCase() && ((t = o), (d = 1), m(), g());
    });
  } catch (e) {}
  function l(e) {
    e.forEach((e) => {
      new Image().src = e.imagen;
    });
  }
  function m() {
    try {
  ...
  function g() {
    try {
      const e = Math.ceil(t.length / n),
        i = document.querySelector(".paginas");
      i.innerHTML = "";
      const a = p();
      for (let o = 1; o <= e; o++) {
        const e = document.createElement("button");
        e.classList.add("paginas__btn"),
          (e.textContent = o),
          o === a && e.classList.add("active"),
          e.addEventListener("click", () => {
            u(o),
              m(),
              i.querySelectorAll(".paginas__btn").forEach((e) => {
  ...
  try {
    let e = document.querySelector(".loader"),
      ...
      a = document.querySelector(".nombrelogo23");
  ...
  try {
    const e = document.querySelector(".navegacion__menu-start"),
      i = document.querySelector(".navegacion__menu-close");
    e.addEventListener("click", () => {
      (e.style.display = "none"), (i.style.display = "inline-block");
    }),
      i.addEventListener("click", () => {
        (e.style.display = "inline-block"), (i.style.display = "none");
      });
  } catch (e) {}
  function v() {
    try {
      let e = !1,
        i = window.innerWidth;
      const a = document.querySelector(".lista__item--desplegable"),
        o = document.querySelector(".lista__drop");
      function t() {
        e
  ...
  let f = function () {
    ...
    h = function () {
      console.log("El cursor ya no está sobre la sublista"),
        (document.querySelector(".lista__drop").style.display = "none");
    };
  window.addEventListener("resize", () => {
    try {
      let e = window.innerWidth,
        i = document.getElementById("icono"),
        a = document.querySelector("#nav");
      document.querySelector(".lista__item--desplegable");
      const o = document.querySelector(".lista__drop");
      v();
      (a ? a.offsetWidth : 0) > 768
        ? ((i.checked = !1),
          (o.style.display = "none"),
          (o.style.display = "absolute"))
        : (o.removeEventListener("mouseenter", f),
